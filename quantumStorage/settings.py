"""
Django settings for quantumStorage project.
...
INSTALLED_APPS = [
    'storageInterface',
    # 'storageInterface.apps.StorageinterfaceConfig',
...
ROOT_URLCONF = 'quantumStorage.urls'
...
WSGI_APPLICATION = 'quantumStorage.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': BASE_DIR / 'StorageDB.sqlite3',
    }
}
